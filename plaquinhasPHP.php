<?php
    ...
    print_r ('<link rel="stylesheet" href="./css/fullPlaquinhas.css">');
    print_r ('<title>Plaquinhas</title>');
    print_r ('</head>');
    print_r ('<body>');
    print_r ('<div class="principal">');
    print_r ('<img src="./img/Plaquinhas AFPESP.jpg" alt="">');
    print_r ('<img src="./img/Plaquinhas AFPESP.jpg" alt="">');
    print_r ('</div>');
    print_r ('<div class="itens">');
    print_r ('<b><p id="p1">'.$p1.'</p>');
